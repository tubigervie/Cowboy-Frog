...
public class WeaponShootEffectSO : ScriptableObject
{
    ...
    #endregion
    #region Tooltip
    [Tooltip("The color gradient for the shoot effect. This gradient shows the color of particles during their lifetime = " +
        "from left to right")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("The number of particles emitter per second. If zero it will just be the burst number")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("weaponShootEffectPreab contains the particle system for the shoot effect - and is configured by the SO")]
    #endregion
