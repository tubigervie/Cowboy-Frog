...
public class SoundEffectSO : ScriptableObject
{
    ...
    [Tooltip("The minimum pitch variation for sound effect. A random pitch variation makes sound effects sound more natural")]
    [Range(0.1f, 1.5f)]
    public float soundEffectPitchRandomVariationMin = 0.8f;
    [Tooltip("The maximum pitch variation for sound effect. A random pitch variation makes sound effects sound more natural")]
    [Range(0.1f, 1.5f)]
    ...
    private void OnValidate()
    {
        ...
        HelperUtilities.ValidateCheckPositiveRange(this, nameof(soundEffectPitchRandomVariationMin), soundEffectPitchRandomVariationMin, nameof(soundEffectPitchRandomVariationMax),
