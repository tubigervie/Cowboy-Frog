...
public class RoomTemplateSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Populate list with all the enemies that can be spawned in this room by dungeon level, including the ratio (random)" +
        "of this enemy type that will be spawned.")]
    #endregion Tooltip
